...
export class PathFinder {
    ...
    constructor( grid , min_x, min_y, max_x, max_y ) {
        this.grid = grid;
    ...
    //-----------------------------
    label_route( node, direction , label ) {
        ...
        if ( node != null ) {
            ...
            if ( direction == "c" ) {
                ...
                while ( pt_node["child"] != null ) {
                    pt_node["label"] = label;
                    pt_node = pt_node["child"];
                }
            
            } else if ( direction == "p" ) {

                while ( pt_node["parent"] != null ) {
                    pt_node["label"] = label;
                    pt_node = pt_node["parent"];
                }
            }
        }
    }
     ...
     //---------------------
    public findSubPath(startX, startY, endX, endY ) {
